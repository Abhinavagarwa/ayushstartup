          ...
          <p><strong>Central Sector Scheme for AYURGYAN</strong><br />
            ...
            <div className={`card-text ${theme}`}>
              <p>
                ...
                <a href = "https://ngo.ayush.gov.in/ayurgyan" target="_blank"><button className = {`siteRefer ${theme}`} >Visit Site</button></a>
              </p>
            </div>
          </p>
        </div>
        ...
        <div className={`cards ${theme}`}>
          <p><strong>Central Sector Scheme for Promotion of Information, Education, and Communication (IEC) in AYUSH</strong><br />
            ...
            <div className={`card-text ${theme}`}>
              ...
              <a href='https://ngo.ayush.gov.in/scheme2' target="_blank"><button className = {`siteRefer ${theme}`}>Visit Site</button></a> 
              </p>
            </div>
          </p>
        </div>
