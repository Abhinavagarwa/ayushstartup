...
return (
      <div className={`container ${theme}`} >
         ...
         <div className = {`mainDiv ${theme}`}>
          ...
          <h1 className = {`heading ${theme}`}><strong>About Us:</strong></h1>
          ...
          <h2 className = {`heading ${theme}`}><strong>Nation Ayush Mission(NAM):</strong></h2>
          ...
          <h2 className = {`heading ${theme}`}><strong>Why Ayush Startup Online Registrations?</strong></h2>
